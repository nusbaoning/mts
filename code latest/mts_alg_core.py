...
def load_file_sieve_original(traceID, typeID, t1=3, t2=1, sizerate=0.4):
	readReq = 0
	size = math.ceil(sizerate*uclnDict[traceID])
...
for l in ["wdev_0"]:
	for j in [0.04, 0.06, 0.08, 0.1, 0.12, 0.14, 0.16]:
		load_file_sieve_original(l, "cam", sizerate=j)
		load_file(l, "cam", mts_cache_algorithm.LFU,sizerate=j)
