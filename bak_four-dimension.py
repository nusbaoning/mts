...
def ssd_statistics(traceID, alg, ucln):
	global reqDict
	tmpDict = []
	...
	for line in lines:
		...
		if reqtype == 1:			
			...
			if readReq % 100000 == 0:
                                ...
                                logFile.close()
                                break
                                # ssd_statistics(traceID, "LRU", uclnDict[traceID])
			result = ssd.is_hit(block)
			print(result, ssd.hit)				
	...
	for line in lines:
		...
		if reqtype == 1:			
			...
			if readReq % 10000 == 0:
                                ...
                                logFile.close()
                                break
                                # ssd_statistics(traceID, "periodLRU", uclnDict[traceID])
			result = ssd.is_hit(block)				
			blocks = ssd.update_cache(block)
			print(result,blocks,ssd.ssd.hit)
			ssd_update(blocks)
	...
	for line in lines:		
		...
		if reqtype == 1:			
			...
			if readReq % 100000 == 0:
                                ...
                                logFile.close()
                                #ssd_statistics(traceID, "MT", uclnDict[traceID])	
			ssd_record(block)
	...
	for line in lines:		
		...
		if reqtype == 1:			
			...
			if readReq % 10000 == 0:
                                ...
                                logFile.close()
                                ssd_statistics(traceID, "SS", uclnDict[traceID])			
			ssd_record(block)			
			hit = ssd.is_hit(block)		
			periodSign += 1				
